...
class Room2 extends StatefulWidget {
  ...
  _Room2 createState() => _Room2();
}

class _Room2 extends State<Room2> {
  @override
  void initState() {
    super.initState();
    getvalues('my/switch_state2', widget.client);
  }
...
////////////////////////////////////
  ...
  void getvalues(String pubTopic, MqttServerClient client) {
    ...
    client.publishMessage('my/topic2', MqttQos.atLeastOnce, builder.payload!);
