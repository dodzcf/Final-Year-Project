...
class Room3 extends StatefulWidget {
  ...
  _Room3 createState() => _Room3();
}

class _Room3 extends State<Room3> {
  @override
  void initState() {
    super.initState();
    getvalues('my/switch_state3', widget.client);
  }
...
////////////////////////////////////
  ...
  void getvalues(String pubTopic, MqttServerClient client) {
    ...
    client.publishMessage('my/topic3', MqttQos.atLeastOnce, builder.payload!);
