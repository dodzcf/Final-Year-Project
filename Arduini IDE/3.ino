// SOME RULES
// WRITE NAME AS "Name" AND VALUE AS "value"
// OTHERWISE THE CODE WILL CUTE THE EXCEPTION
// ALSO USE A STRONG WIFI CONNECTION OR ELSE IT WILL GIVE CONNECTING TO MQTT ERROR
...
const char *topic = "my/topic3";
const char *topic2 = "my/switch_state3";
...
if (strcmp(topic.c_str(), "my/topic3") == 0)
{
    Serial.print("Topic: ");
...
if (strcmp(name, "Get Data") == 0)
{
 ...
 mqttClient.publish("my/switch_state3", jsonStr);
 Serial.print("\nSent Data");
 return;  }
  else{
   StaticJsonDocument<200> message2;
...
///////////////////////FAN/////////////////////////
  ...
  mqttClient.connect("ESP8266Client", mqtt_username, mqtt_password);
  mqttClient.subscribe("my/topic3");
